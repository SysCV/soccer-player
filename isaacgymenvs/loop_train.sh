train_args=("Go1PPO" "Go1PPOrnn" "Go1PPOhistory" "Go1PPOsea" "Go1PPOrma" "Go1PPOwaq")
seeds=(42 2 17 13)

#     for train_arg in "${train_args[@]}"; do
#         for seed in "${seeds[@]}"; do
#             python train.py task=Go1 train="$train_arg" wandb_activate=true capture_video=true experiment="fix_$train_arg" seed="$seed" max_iterations=3000
#         done
#     done
# done
